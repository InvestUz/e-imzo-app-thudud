    ...
    <div class="auth-topbar">
        <a href="{{ route('home') }}" class="auth-brand">
            ...
            <div class="auth-brand-text">
                <span class="auth-brand-title">TUTASH HUDUDLAR REESTRI</span>
                <span class="auth-brand-sub">Yagona identifikatsiya tizimi</span>
            </div>
        </a>
    ...
    <main class="auth-main">
        <div class="auth-card">
            ...
            <div class="auth-card-header">
                ...
                <div class="auth-card-sub">Shaxsiy kabinetingizga kiring</div>
            </div>
